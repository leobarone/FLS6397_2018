...
```{r}
library(readr)
escolas <- read_delim("C:\\users\\jonny\\downloads\\temp.csv", delim = ";")
...
Para analisar estes dados como dados espaciais precisamos dizer a R quais são as variáveis de localização e transformá-lo em um objeto 'simple features' usando o biblioteca _sf_ e a função _st\_as\_sf_ para criar um objeto tipo "simple features". 
