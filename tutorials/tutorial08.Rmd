...
4. **Git** - sistema de controle de versão e compartilhamento de projeto (demonstração separada em aula)
...
A outra vantagem de trabalhar em projetos é que eles facilitam o uso do controle de versão de Git dentro do Rstudio (vamos discutir mais na aula).

Para abrir um projeto, simplesmente escolhe File -> New Project -> New Directory -> New Project e digite o nome desejado da pasta do projeto. Dado que um projeto é apenas uma pasta, em seguida precisamos abrir um script novo e salvá-lo na mesma pasta. 
...
Para transformar o nosso script ".Rmd" para um PDF, clique no botão "Knit". Feito. O documento o documento é salvo na pasta de trabalho (do projeto atual). Para criar um outro formato de documento, clique a flecha ao lado de "Knit" e eschole o formato preferido. 
