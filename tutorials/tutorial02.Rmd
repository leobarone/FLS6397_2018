...
Voltaremos aos "factors" em momento adequado. O importante agora é saber que eles existem e que é uma classe de vetores em R. Ao importarmos bases de dados para o "Environment", verifique se sua variável fosse importada como uma variável de caractere ou fator. Como avisei no início deste tópico, "factors" é um dos aspectos mais confusos em R (em conjunto com "missing values", que vamos adiar até um momento adequado).
